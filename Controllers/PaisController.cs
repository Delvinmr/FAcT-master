...
namespace FAcT.Controllers
{
    public class PaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("paisID,Codigo,nombre_pais,MonedaID")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("paisID,Codigo,nombre_pais,MonedaID")] Pais pais)
        {
            if (id != pais.paisID)
            {
                return NotFound();
