...
namespace FAcT.Controllers
{
    public class SectorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("sectorID,Codigo,nombre_sector,municipioID")] Sector sector)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("sectorID,Codigo,nombre_sector,municipioID")] Sector sector)
        {
